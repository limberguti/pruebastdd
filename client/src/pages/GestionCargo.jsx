      ...
      <div class="container">
        <div className="row custom-row">
          <div className="col-lg-3 justify-content-center align-center">
            ...
            <Link to="/AddCargo" className="enlace"> <h1> Agregar </h1> </Link>
          </div>
          <div className="col-lg-3">
            <img src={modificar} alt="" className="imagen" />
            <Link to="/UpdateCargo" className="enlace"> <h1>Modificar</h1></Link>
          </div>
          <div className="col-lg-3">
            <img src={buscar} alt="" className="imagen" />
            <Link to="/SearchCargo" className="enlace"> <h1>Buscar</h1></Link>
          </div>
        </div>
      </div>
