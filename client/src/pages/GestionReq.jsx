      ...
      <div className="container">
        <div className="row custom-row">
          <div className="col-lg-3 justify-content-center align-center">
            ...
            <Link to="/AddReq" className="enlace"> <h1> Agregar </h1> </Link>
          </div>
          <div className="col-lg-3">
            <img src={modificar} alt="" className="imagen" />
            <Link to="/UpdateReq" className="enlace"> <h1>Modificar</h1></Link>
          </div>
          <div className="col-lg-3">
            <img src={buscar} alt="" className="imagen" />
            <Link to="/SearchReq" className="enlace"> <h1>Buscar</h1></Link>
          </div>
        </div>
      </div>
