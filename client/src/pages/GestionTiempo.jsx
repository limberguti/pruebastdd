...
const GestionTiempo = () => {
  ...
  return (
    <section className="gestion">
      ...
      <label><strong> Tiempos </strong> </label>
      <div class="container">
        <div className="row custom-row">
          <div className="col-lg-3 justify-content-center align-center">
            <img src={agregar} alt="" className="imagen" />
            <Link to="/AddTiempo" className="enlace"> <h1> Agregar </h1> </Link>
          </div>
          <div className="col-lg-3">
            <img src={modificar} alt="" className="imagen" />
            <Link to="/UpdateTiempo" className="enlace"> <h1>Modificar</h1></Link>
          </div>
          <div className="col-lg-3">
            <img src={buscar} alt="" className="imagen" />
            <Link to="/SearchTiempo" className="enlace"> <h1>Buscar</h1></Link>
          </div>
        </div>
      </div>
